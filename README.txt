...
NOTE:
The dataset needed for STF is the MSRC Object Database v2, it can be downloaded at the link below, You need to copy the following into the folder ObjectDetectionFinalProject/CODE/PlugNPlay STF/MSRC_ObjCategImageDatabase_v2
folders to be copied:

GroundTruth
Images
SegmentationsGTHighQuality
