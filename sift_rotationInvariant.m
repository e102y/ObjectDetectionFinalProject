%This script demonstrates the rotaiton invariant property of the SIFT decriptor
...
%% Resize the image by a factor of 2 and rotate image by 30 degrees
I2 = imresize(I1, 2);       
I2 = imrotate(I2, 30);
figure, imshow(I2,[]);
[f2,d2] = vl_sift(I2);
...
legend('SIFT descriptor for original image', 'SIFT descriptor for modified image');