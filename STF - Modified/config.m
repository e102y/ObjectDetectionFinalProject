...
%%%%%%%%%%%%%%%%%%%%
% directory settings
DIR.dataset ='/Users/student/Desktop/Semantic-texton-forests-master/MSRC_ObjCategImageDatabase_v1/';
DIR.images = fullfile(DIR.dataset, 'Images');
DIR.groundTruth = fullfile(DIR.dataset, 'GroundTruth');
DIR.result = '/Users/student/Desktop/Semantic-texton-forests-master/MSRC_ObjCategImageDatabase_v1/results/';
...
LABELS = buildLabels(DIR.groundTruth, PATH.trainingNames);
